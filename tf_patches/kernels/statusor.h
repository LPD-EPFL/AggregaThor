...
#include "tensorflow/contrib/mpi_collectives/kernels/port.h"
#include <type_traits>
#include <utility>
...
#include "tensorflow/contrib/mpi_collectives/kernels/error.h"
#include "tensorflow/contrib/mpi_collectives/kernels/status.h"
#include "tensorflow/contrib/mpi_collectives/kernels/logging.h"
namespace perftools {
namespace gputools {
namespace port {
